        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {items.map((t, i) => (
            <FadeIn key={i} delay={i * 0.08}>
              <div className={`relative h-full p-8 rounded-2xl border ${isDark ? 'bg-white/5 border-white/10' : 'bg-white border-darpanNavy/10'} hover:shadow-lg hover:-translate-y-1 transition-all`}>
